    ...
    return (
        <section className='w-full relative top-60' id='project'>
            <div className='w-[95%] max-w-[750px] h-auto flex flex-col items-center justify-center mx-auto gap-8'>
                ...
                <a className='flex flex-col md:flex-row w-full rounded-2xl bg-[#e0dcdc] hover:bg-white transition-all duration-200 hover:scale-101 md:hover:scale-103 cursor-pointer
                                outline-none border-none'
                   href='https://github.com/qbael/HealthPro' target='_blank'
                >
                ...
                <a className='flex flex-col md:flex-row w-full rounded-2xl bg-[#e0dcdc] hover:bg-white transition-all duration-200 hover:scale-101 md:hover:scale-103 cursor-pointer
                                outline-none border-none'
                   href='https://github.com/mindangg/AskRepo' target='_blank'
                >
                    <div className='w-full md:w-1/3 flex flex-col items-center p-3'>
                        <p className='text-md text-black font-semibold mb-2'>Febuary 2026</p>
                        <img src={healthpro} className='w-[85%] object-cover rounded-2xl'/>
                    </div>

                    <div className='w-full md:w-2/3 text-black p-5 rounded-lg flex flex-col justify-between'>
                        <div className='mb-5 md:mt-0'>
                            <h1 className='text-2xl font-bold mb-3'>AskRepo</h1>
                            <p className='text-md md:text-[15px]'>A full-stack GitHub Repository RAG System with a local AI architecture, featuring hybrid semantic search and an intelligent chat interface for querying any codebase with exact file and line citations.</p>
                        </div>
                ...
                <a className='flex flex-col md:flex-row w-full rounded-2xl bg-[#e0dcdc] hover:bg-white transition-all duration-200 hover:scale-101 md:hover:scale-103 cursor-pointer
                                outline-none border-none'
                   href='https://github.com/mindangg/Manga-2.0' target='_blank'
                >
                    <div className='w-full md:w-1/3 flex flex-col items-center p-3'>
                ...
                <a className='flex flex-col md:flex-row w-full rounded-2xl bg-[#e0dcdc] hover:bg-white transition-all duration-200 hover:scale-101 md:hover:scale-103 cursor-pointer
                                outline-none border-none'
                   href='https://github.com/mindangg/Hackathon' target='_blank'
                >
                    <div className='w-full md:w-1/3 flex flex-col items-center p-3'>
